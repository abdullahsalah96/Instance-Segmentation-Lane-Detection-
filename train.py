...
train_images = np.uint8(segmentation.load_images(TRAIN_IMAGES_PATH,"*.png", GRAYSCALE, True, (WIDTH, HEIGHT)))

#Loading train  annotations
train_annotations = np.uint8(segmentation.load_images(TRAIN_ANNOTATIONS_PATH,"*.png", True, False, (WIDTH, HEIGHT)))
...
unet_model.save(r"lane_model.h5")
